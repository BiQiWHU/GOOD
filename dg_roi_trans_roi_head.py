...
class DGRoITransRoIHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        super(DGRoITransRoIHead, self).__init__(init_cfg)
    ...
    def forward_train(self,
        ...
        for i in range(self.num_stages):
            ...
            bbox_results_clip_styled = self._bbox_forward_train(i, x_clip_styled, sampling_results,
                                                    gt_bboxes, gt_labels,
                                                    rcnn_train_cfg)            
